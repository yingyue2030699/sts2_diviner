...
This is a design draft, not final balance. Costs, numbers, and rarity are chosen to create a playable identity before engine constraints and playtesting force adjustments.
...
| Read the Ashes | Skill | 1 | Exhaust a card. Foretell: draw 1 card. If a Status or Curse is Exhausted, Foretell: Gain 2 energy.  | Cost 0. |
...
| White Room | Skill | 1 | Draw 2 cards. Enlightenment: choose up to 2 cards in your hand. It is Fated. | Choose up to 3 cards. |
...
| Haruspex Method | Power | 1 | The next time you Exhaust a card, Divinate and Foretell: Add a "Haruspex Method" to your hand. | 0 cost; Foretell: Add a "Haruspex Method+" to your hand. |
...
| Doom Engine | Power | 2 | Misfortunes HP lost reduced by 1 and deal 9 more damage. Add 1 Misfortune to your hand. | HP lost reduced by 2 and deal 13 more damage. |
| Ledger of Signs | Power | 1 | Every 3 times you Foretell, add Fortune to your hand. | Cost 0. |
...
| Oracle's Bargain | Skill | 1 | Gain 1 Destiny and add 3 Misfortunes to your draw pile. Exhaust. | 0 cost. |
...
| Many Futures | Power | 2 | Card rewards at the end of this combat have 1 additional option. When your Scry, choose 1 additional card. | Costs 1. |
