...
| Doomscript | Attack | 1 | Deal 6 damage. Add a Misfortune to your draw pile. | 9 damage. Add a Misfortune+ to your draw pile. |
| Crossed Lines | Attack | 0 | Deal 3 damage. If you have Divinated this combat, apply 3 Weak. | Deal 4 damage, apply 4 Weak. |
| Thread Cut | Attack | 1 | Deal 6 damage. If the target has Weak, then deal 10 damage. | 8 damage, then 12 damage. |
...
| Divulge | Skill | 0 | Divinate and draw 1 card. Lose 1 Destiny. | Divinate and draw 2 cards. Lose 1 Destiny. |
...
| Star Needle | Attack | 0 | Deal 1 damage and apply 1 Vulnerable. Damage increases by 1 for every recorded divination. | Deal 2 damage and apply 2 Vulnerable. Damage increases by 1 for every recorded divination. |
...
| Inevitability | Attack | 4 | Deal 52 damage. Costs 1 less for every 7 recorded divinations. | Costs 1 less for every 5 recorded divinations. |
...
| Name | Type | Cost | Effect | Upgrade |
|---|---|---:|---|---|
| Apocalypse | Attack | 2 | Deal 9 damage to a random enemy 9 times. Add Destiny to this card's cost after cost reductions. | Deal 10 damage to a random enemy 10 times. |
...
| Unavoidable End | Attack | 2 | Deal 8 damage. Foretell: deal three times the damage actually dealt, including overkill, to all enemies. | 11 damage. |
...
| Greater Portent | Skill | 4 | Exhaust. Search up to 3 cards from your draw pile. Put them into your hand; they are Fated. | Costs 3. |
