...
| Doomed | Destiny exactly 0. At combat start, gain 3 Countdown of Destiny and shuffle 3 Escape from Destiny cards into the draw pile. |
| Revelation | Destiny exactly 5. At combat start, search for 3 cards, put them into your hand, and make them cost 0 this turn. When card extra effect with Revelation is triggered, lose 1 destiny |
...
| Crossed Lines | Attack | 0 | Deal 3 damage. If you have Divinated this combat, apply 2 Weak. | Deal 4 damage, apply 3 Weak. |
...
| Forewarned Blow | Attack | 2 | Deal 15 damage. Add a Misfortune to your draw pile. | 20 damage. Add a Misfortune+ to your draw pile. |
...
| Insurance | Skill | 1 | Gain 6 Block. You no longer lose HP from Misfortune at the end of this turn. | Gain 9 Block. |
...
| Palm Reading | Skill | 1 | Scry 6. Good Omen: draw 2 cards. Bad Omen: Gain 9 Block. | Scry 8. Good Omen: draw 3 cards. Bad Omen: Gain 12 Block. |
...
| Divulge | Skill | 0 | If not Doomed, Divinate and draw 1 card. Lose 1 Destiny.  | If not Doomed, Divinate and draw 2 cards. Lose 1 Destiny. |
| Sacrifice of Certainty | Skill | 0 | Gain 3 energy. Lose 1 Destiny. | Gain 4 energy. |
| Omens Align | Skill | 1 | Exhaust. Put all Fortune and Misfortune cards from anywhere into your hand. | No longer Exhausts. |
| Smoke and Mirrors | Skill | 1 | Gain 8 Block. The next Foretell effect you play this combat resolves with 8 more damage or Block. | Gain 10 Block Foretell bonus becomes 10 more. |
...
| Narrow Escape | Skill | 1 | Gain 9 Block. Doomed: gain 2 Countdown of Destiny. | Doomed: gain 3 Countdown of Destiny. |
...
| Doom Engine | Power | 2 | Misfortunes' HP loss is reduced by 2 and they deal 5 more damage. At start of turn, return a Misfortune from your discard pile to your hand. Doomed: this card costs 0. | Cost 1. |
...
| Hexagram | Attack | 2 | Deal 3 damage to a random enemy 6 times. Revelation: Damage increased by 7. | 4 damage 6 times. Damage increased by 9. |
...
| Cursed Prediction | Attack | 1 | Deal 11 damage. Bad Omen: add a Misfortune to your hand. | Deal 14 damage. |
| Dead Star | Attack | 2 | Deal 18 damage. Lose 1 HP. Bad Omen: deal 18 damage again. | 22 damage; Bad Omen deal 22 damage again. |
| Augury | Skill | 2 | Exhaust. If you have divinated this combat, gain 1 Destiny. Otherwise gain 12 Block. | 16 Block. |
| Lucky Break | Skill | 0 | Gain 3 Block. Good Omen: Draw 1 card. | Gain 5 Block. |
...
| Evil Eye | Skill | 1 | Apply 3 Weak. Bad Omen: gain 2 Energy. | Apply 5 Weak. |
...
| Epiphany | Skill | 4 | Gain 1 destiny. Exhaust. | Lose Exhaust. |
...
| Chosen Line | Power | 1 | Only playable if Revelation. The first card you draw each turn is Fated. Draw 1 extra card per turn. | Costs 0. |
| Ledger of Signs | Power | 1 | Every 3 times you Foretell, add a Fortune to your hand. | Add a Fortune+ to your hand. |
...
| Name | Type | Cost | Effect | Upgrade |
|---|---|---:|---|---|
| Apocalypse | Attack | 1 | Deal 8 damage to random enemy 8 times. Add Destiny to the cost of this card.  | Deal 9 damage to random enemy 9 times. |
| Hand of Fate | Attack | 1 | Deal 13 damage. Draw 1 card. Revelation: do this 3 times. | 16 damage. Revelation: do this 4 times.  |
| The Last Word | Attack | 2 | Retain.  Deal 25 damage. If Fatal, gain 1 Destiny. Exhaust. | 33 damage. |
...
| Clairvoyance | Skill | 2 | Search anywhere for 1 card. Put it into your hand; it is Fated. | Cost 1. |
| Reversal | Skill | 0 | Exhaust. Set Destiny to 5 minus its current value. | Gains Retain. |
| Oracle's Bargain | Skill | 1 | Gain 1 Destiny. Shuffle 3 Misfortunes into your draw pile. | Costs 0. |
| Omen of Fallen Sky | Skill | 3 | Foretell: Deal 60 damage to all enemies. | Deal 75 damage. |
| Omen of Transcendence | Skill | 1 | Foretell: Draw 4 cards and gain 3 energy. | Draw 5 cards and gain 4 energy. |
| Relic Banishing | Skill | 1 | Divinate twice for relic divinations only. Add a Bend Future to your hand. Exhaust. | Add a Bend Future+. |
...
| Fixed Point | Power | 1 | Destiny cannot change this combat. | 0 |
...
|---|---|---:|---|---|
| Escape from Destiny | Skill | 1+ | Exhaust. Doomed only. Gain 1 Countdown of Destiny. Escape from Destiny costs 1 more this combat. | Generated at combat start while Doomed. |
